...
namespace BisCarePosEdition
{
    public partial class Item : Form
    {
      ...
      public int strv = 0;
        private void btn_save_Click(object sender, EventArgs e)
          {
            try
            {
                ...
                if (cmb_taxid.SelectedIndex <= 0)
                {
                    MessageBox.Show("Please select tax", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cmb_taxid.Focus();
                    return;
                }
                if (rd_Prodect.Checked == true)
                    ...
                    if (SaveStatus == "1")
                    {
                        ...
                        if (stat == "0")
                        {
                            ...
                            string msg = obj.InserorUpdateItem(cmb_catname.SelectedValue.ToString(), txt_itemcode.Text, txt_itemname.Text, "0",
                                Cmb_UnitType.SelectedValue.ToString(), txt_barcode.Text, txt_codeprice.Text,cmb_taxid.SelectedValue.ToString(),txt_sellprice.Text, s, "0", "1", pi, txtSellPriceNonAC.Text,
                    ...
                    if (UpdateStatus == "1")
                    {
                        if (Cmb_itemname.SelectedIndex > 0)
                        {
                            ...
                            if (stat == "0")
                            {
                                strv = 0;
                                string msg = obj.InserorUpdateItem(cmb_catname.SelectedValue.ToString(), txt_itemcode.Text, txt_itemname.Text, "0",
                                    Cmb_UnitType.SelectedValue.ToString(), txt_barcode.Text, txt_codeprice.Text, cmb_taxid.SelectedValue.ToString(), txt_sellprice.Text, s, 
        ...
        private void TaxEnableDisable(int Stat)
        {
            if (Rb_new.Checked == true)
            {
                if (Stat == 0)
                {
                    cmb_taxid.SelectedValue = 1;
                    cmb_taxid.Enabled = false;
                }
                if (Stat == 1)
                {
                    cmb_taxid.SelectedValue = 2;
                    cmb_taxid.Enabled = false;
                }
                if (Stat == 2)
                {
