...
namespace BisCarePosEdition
{
    class Codebehind
    {
        ...
        SqlConnection Onlinecon = new SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings["OnlineConnection"].ConnectionString);
        ...
        public void OpenOnlinecon()
        {
            if (Onlinecon.State == ConnectionState.Open)
    ...
    /////////////////////
        ...
        ////
          ...
          public DataTable CompanyIsActiveView()
          {
              DataTable dtbl = new DataTable();
              try
              {
                  Opencon();
                  SqlDataAdapter sdaadapter = new SqlDataAdapter("CompanyIsActiveView", con);
          ...
          public DataTable ProductActivationViewAll(string ClientCode)
          {
              DataTable dtbl = new DataTable();
              try
              {
                  if (Onlinecon.State == ConnectionState.Closed)
                  {
                      Onlinecon.Open();
                  }
                  SqlDataAdapter sdaadapter = new SqlDataAdapter("ProductActivationViewAll", Onlinecon);
                  sdaadapter.SelectCommand.CommandType = CommandType.StoredProcedure;
                  SqlParameter sprmparam = new SqlParameter();
                  sprmparam = sdaadapter.SelectCommand.Parameters.Add("@ClientCode", SqlDbType.VarChar);
                  sprmparam.Value = ClientCode;
          ...
          public void UpdateClientActiveStatus(int IsActive)
          {
              try
              {
                  ...
                  SqlCommand sqlcmd = new SqlCommand("UpdateClientActiveStatus", con);
