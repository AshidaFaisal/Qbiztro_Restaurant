...
namespace BisCarePosEdition
{
    public partial class ProductStock : Form
    {
       ...
       string  Productstatus = "0";
                        ...
                        if (txtDealerRefNo.Text != "" || Rb_OldStock.Checked == true)
                        {
                            if (Convert.ToDouble(cboxPurchaser.SelectedValue) > 0)
                            {
                                ...
                                if (stat == "0")
                                {
                                    ...
                                    string Sid = obj.InsertProductStockMaster(Convert.ToDateTime(dtp_stockdate.Value), cboxPurchaser.SelectedValue.ToString(),"1", "0");
                                    for (int i = 0; i < gv_stock.Rows.Count; i++)
                                    {
                                        ...
                                        obj.InsertProductStockDetails(Sid, gv_stock[9, i].Value.ToString(), gv_stock[5, i].Value.ToString(), gv_stock[8, i].Value.ToString(), "1", "0");

                                    }
                                }
                                MessageBox.Show("Product Stock Successfully saved", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                reset();
                               cmb_itemname.Focus();
                            }
                            else
        ...
        {
            try{
                ProductStockEntrySearch s = new ProductStockEntrySearch();
            s.ShowDialog();
            string id = s.id;
            stockid = id;
                if (s.dr == DialogResult.OK)
            {
                ...
                dtm = obj.GetProductStockMaster(id);
                if (dtm.Rows.Count > 0)
                {
                ...
                dt = obj.GetProductStockDetails(id);
                int i;
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            try
            {
                            ...
                            if (txtDealerRefNo.Text != "" || Rb_OldStock.Checked == true)
                            {
                                if (Convert.ToDouble(cboxPurchaser.SelectedValue) > 0)
                                {
                                    ...
                                    if (stat == "0")
                                    {
                                        ...
                                        obj.InsertProductStockMaster(Convert.ToDateTime(dtp_stockdate.Value), cboxPurchaser.SelectedValue.ToString(), "0", stockid);
                                        decimal newInteger;
                                        NumStat = 0;
                                        ...
                                        else
                                        {
                                            for (int i = 0; i < gv_stock.Rows.Count; i++)
                                            {
                                                ...
                                                obj.InsertProductStockDetails(stockid, gv_stock[9, i].Value.ToString(), gv_stock[5, i].Value.ToString(), gv_stock[8, i].Value.ToString(), "1", txtsid.Text);
                                                    
                                                
                                            }
                                            MessageBox.Show("Product Stock Successfully Updated", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                            reset();
                                        }
                                    }
                                }
                ...
                else
                {
                    ...
                    MessageBox.Show("You Do Not Have The Permission To Update  Product Stock", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (DeleteStatus == "1")
            {
                if (gv_stock.Rows.Count >= 1)
                {
                     ...
                     int stat=obj.DeleteProductStockEntry(stockid);
                     if (stat==0)
                     {
