...
namespace BisCarePosEdition
{
    public partial class Billing : Form
    {
        ...
        Font myfontb23 = new Font("Arial", 10, FontStyle.Bold);
        ...
        
       {
            try
            {
                ...
                if (custst == "1")
                {
                    ...
                    {
                      string  mg = obj.InsertKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total.Text, "0", cbox_table.SelectedValue.ToString(), cbox_waiter.SelectedValue.ToString(), custst, "0", dtpDate.Value, li[i],tokenst,txt_packing.Text,txtInvoiceNumber.Text);
        ...
        int g = 0;
        int ACStatus=0;//To check the table is in AC or Non AC
                     ...
                     if (f == 1)
                     {
                         ...
                         for (int d = 0; d < dt.Rows.Count; d++)
                         {
                             ...
                             dgv_KotDetails[9, d].Value = dt.Rows[d]["Id"].ToString();
                               dgv_KotDetails[18, d].Value = dt.Rows[d]["Pkg_charge"].ToString();
                               txt_packing.Text = dt.Rows[d]["Pkg_charge"].ToString();
                             // dgv_KotDetails[15, d].Value = dt.Rows[d]["department"].ToString();
                              dgv_KotDetails[17, d].Value = dt.Rows[d]["Id"].ToString();
                         ...
                         total = total + Convert.ToDouble(txt_packing.Text);
             ...
             if (dgv_ItemDteails.Rows.Count > 0)
                {
                    if (custst == "2")
                    {
                        ...
                        for (i = 0; i < li.Count; i++)
                        {
                            msg = obj.InsertKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total1.Text, "0", cbox_table.SelectedValue.ToString(), cbox_waiter.SelectedValue.ToString(), custst, cbox_Token.Text, dtpDate.Value, li[i], tokenst,txt_packing.Text,txtInvoiceNumber.Text);
                            ...
                            if (dt.Rows[0]["DeptId"].ToString() == "2")
                            {
                                PrintKOTTake2();
                                //clear();
                    ...
                    if (custst == "4")
                    {
                        msg = obj.InsertKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total.Text, "0", "0", "0", custst, cbox_Token.Text, dtpDate.Value, txtdepartment.Text, tokenst, txt_packing.Text, txtInvoiceNumber.Text);
                        for (int i = 0; i < dgv_ItemDteails.Rows.Count; i++)
                        {
                    ...
                    if (custst == "1")
                    {
                        ...
                        for (i = 0; i < li.Count; i++)
                        {
                            msg = obj.InsertKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total.Text, "0", cbox_table.SelectedValue.ToString(), cbox_waiter.SelectedValue.ToString(), custst, "0", dtpDate.Value, li[i], tokenst, txt_packing.Text, txtInvoiceNumber.Text);
    ...
    try
    {
        ...
        public void PrintKOT2()
        {
            try
            {
                ...
                PrintDocument doc1 = new PrintDocument();
                doc1.PrintPage += this.Doc_PrintPageKOT;
                doc1.PrinterSettings.PrinterName = File.ReadAllText("Printer2.txt");
                doc1.PrinterSettings.DefaultPageSettings.Margins = new Margins(0, 0, 0, 0);
                //doc.OriginAtMargins = true;     
                try
                {
        ...
        
    {
                        ...
                        if (rd_counterBill.Checked == true)
                        {
                            ...
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), CustName, txtMobile.Text,
                                  ...
                                  0  ,txt_total1.Text,"0.00", "Billing");
                ...
                if (dtCounterBill.Rows.Count > 0)
                {
                  ...
                  //float xamount = 200;
                    ...
                    if (result3 != null)
                    {
                     ...
                     e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["BillName"].ToString(), 46), myfontb23, new SolidBrush(Color.Black), 0, y);
                    lineHeight = font12.GetHeight(e.Graphics);
                    y += lineHeight;
                    ...
                    double total = 0, pckcharge=0, amt=0;
                    lineHeight = font8.GetHeight(e.Graphics);
                    int slnum = 1;
                    ...
                    for (int i = 0; i < dtCounterBill.Rows.Count; i++)
                    {
                        ...
                        amt += Convert.ToDouble(dtCounterBill.Rows[i]["Netamount"]);
                    ...
                    else
                    {
                            ...
                            if (Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString()) >0)
                        {
                            ...
                            e.Graphics.DrawString("NetValue : Rs." + (total - Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString()) + pckcharge).ToString("F2"), font15, sBrush, 40, y);
                            lineHeight = font12.GetHeight(e.Graphics);
                            y += lineHeight;
                        }
                   ...
                   if(dtprintfeatures.Rows[0]["BillName"].ToString()!=null)
                   {
                    ...
                    {        
                        ...
                        y += lineHeight;
                            ...
                            e.Graphics.DrawString("NetValue : Rs." + (total - Convert.ToDouble(dtBill.Rows[0]["discount"].ToString()) + pckcharge).ToString("F2"), font15, sBrush, 40, y);
                            lineHeight = font12.GetHeight(e.Graphics);     
                        }
        ...
        private void dgv_KotDetails_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                txt_total1.Text = string.Format("{0:0.00}", Convert.ToDouble(txt_total.Text));
                txt_total.Text = string.Format("{0:0.00}", Convert.ToDouble(txt_total.Text));
                txt_packing.Text = string.Format("{0:0.00}", Convert.ToDouble(txt_packing.Text));
            }
        ...
        {
            //if (cbox_Token.SelectedText != "" && cbox_ItemCode.SelectedText != "--Select One--")
            //{
            //txt_packing.Focus();
            //}
                ...
                if (cbox_Token.Text != string.Empty)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        for (int d = 0; d < dt.Rows.Count; d++)
                        {
                            ...
                            dgv_KotDetails[9, d].Value = dt.Rows[d]["Id"].ToString();
                            dgv_KotDetails[18, d].Value = dt.Rows[d]["Pkg_charge"].ToString();
                            //dgv_KotDetails[19, d].Value = dt.Rows[d]["TotalAmount"].ToString();
                            //if (txt_total1.Text != "0")
                            //{
                            //    txt_total1.Text = dt.Rows[d]["TotalAmount"].ToString();
                            //}
                            txt_packing.Text = dt.Rows[d]["Pkg_charge"].ToString();
                    ...
                    {
                        total += (Convert.ToDouble(dgv_KotDetails[5, r].Value));
                        //pkg = (Convert.ToDouble(dgv_KotDetails[18, r].Value));

                    }
                    total = total + Convert.ToDouble(txt_packing.Text);
                    txt_total.Text = Convert.ToString(decimal.Round(Convert.ToDecimal(total), 2, MidpointRounding.AwayFromZero));
                    //txt_total1.Text = Convert.ToString(decimal.Round(Convert.ToDecimal(total)+(Convert.ToDecimal(txt_packing.Text)) , 2, MidpointRounding.AwayFromZero));
                   // txt_packing.Text = Convert.ToString(decimal.Round(Convert.ToDecimal(pkg), 2, MidpointRounding.AwayFromZero));
                   // txt_total1.Text = string.Format("{0:0.00}", Convert.ToDouble(txt_total1.Text));

                  

                    txt_packing.Text = string.Format("{0:0.00}", Convert.ToDouble(txt_packing.Text));
                    if (txt_packing.Text == "0.00")
                    {
                        txt_packing.Text = "0 ";
                        ...
                        if (rd_counterBill.Checked == true)
                        {
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), txtCustName.Text, txtMobile.Text, txtEmail.Text, 3, txt_total.Text, combliment,
                                    ...
                                    , 0, txt_total1.Text, "0.00", "Billing");//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                if (combliment == 1)
                                {
                                    obj.InsertComplimentary(msg, remarks);
                                }
                            ...
                            if (dgv_KotDetails.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    msg1 = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), txtCustName.Text, txtMobile.Text, txtEmail.Text, status, txt_total.Text, combliment, txt_discount.Text, paidamnt, customerst,
                                        customerid, "0.00", user, billtype, Convert.ToDateTime(globalvariable.StoreDate), 0, txt_total1.Text, "0.00", "Billing");
                                    if (combliment == 1)//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                    {
                                        obj.InsertComplimentary(msg1, remarks);
                                    }
...
{
    string custst = "1";
    if (Convert.ToDouble(cbox_table.SelectedValue) != 0)
    {
...
if (e.ColumnIndex == 13)
{
    ...
    if (DeleteStatus == "1")
    {
        DialogResult dr = MessageBox.Show("Are you sure to delete this kot ?", "Warning", MessageBoxButtons.
YesNo, MessageBoxIcon.Question);
        if (dr == DialogResult.Yes)
        {


           // string token_selected= cbox_Token.SelectedItem.ToString();
            ...
            obj.DeleteKotDetaile(dgv_KotDetails[8, e.RowIndex].Value.ToString(), cbox_table.SelectedValue.ToString(), cbox_Token.Text, mode.ToString());
            //}
            //else
            //{

            //    obj.DeleteKotDetaile(dgv_KotDetails[8, e.RowIndex].Value.ToString(), cbox_Token.SelectedItem.ToString(), mode);
            //}
            ...
            obj.DeleteKotMaster(dgv_KotDetails[8, e.RowIndex].Value.ToString(), cbox_table.SelectedValue.ToString(), cbox_Token.Text, mode.ToString());
            //}
            //else 
            //{


            //    obj.DeleteKotMaster(dgv_KotDetails[8, e.RowIndex].Value.ToString(), cbox_Token.SelectedValue.ToString(), mode);
    ...
    else 
    {
        ...
        if (dp.Dr == DialogResult.OK)
        {
            //string id = obj.InsertDeletedKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total1.Text, billingst, dgv_KotDetails[10, e.RowIndex].Value.ToString(), dgv_KotDetails[11, e.RowIndex].Value.ToString(), custst, dgv_KotDetails[12, e.RowIndex].Value.ToString(), dtpDate.Value, dgv_KotDetails[9, e.RowIndex].Value.ToString());
            //obj.InsertDeletedKotDetail(id, dgv_KotDetails[8, e.RowIndex].Value.ToString(), dgv_KotDetails[3, e.RowIndex].Value.ToString(), dgv_KotDetails[4, e.RowIndex].Value.ToString(), dgv_KotDetails[5, e.RowIndex].Value.ToString());
            //obj.DeleteKotDetaile(dgv_KotDetails[14, e.RowIndex].Value.ToString(), txtInvoiceNumber.Text);
            //txt_total.Text = (Convert.ToDouble(txt_total.Text) - Convert.ToDouble(dgv_KotDetails[5, e.RowIndex].Value.ToString())).ToString("F2");
            //obj.DeleteKotMaster(dgv_KotDetails[9, e.RowIndex].Value.ToString(), txtInvoiceNumber.Text);
            //dgv_KotDetails.Rows.Remove(dgv_KotDetails.Rows[e.RowIndex]);
        }
    }
}
...
File.AppendAllText("log.txt", DateTime.Now.ToString() + " - " + this.Name + Environment.NewLine + ex.ToString() + Environment.NewLine);
        ...
        private void txt_packing_Click(object sender, EventArgs e)
        {
            ...
            txt_packing.SelectAll();//txt_packing.Text = "0.00";
        ...
        private void txt_packing_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txt_packing.Text == "" || txt_packing.Text == " ")
            {
                txt_packing.Text = " 0.00";
            }
            else
            {
                ...
                //txt_total.Text = (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(txt_packing.Text) - Convert.ToDouble(txt_discount.Text)).ToString("F2");
            }
            ...
            //{
                //if (Convert.ToInt32(txt_packing.Text).ToString() != " 0" || txt_packing.Text != "")
                //{
                //    txt_total1.Text = (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(txt_packing.Text) - Convert.ToDouble(txt_discount.Text)).ToString("F2");
                //    //txt_total.Text = (Convert.ToDouble(txt_total.Text) + Convert.ToDouble(txt_packing.Text) - Convert.ToDouble(txt_discount.Text)).ToString("F2");
                //}
        ...
        private void txt_packing_MouseClick(object sender, MouseEventArgs e)
        {
           // ((TextBox)sender).SelectAll();
           // txt_packing.SelectAll();
        }

        private void txt_packing_Enter(object sender, EventArgs e)
        {
            if (txt_packing.Text == "0.00")
            {
                txt_packing.SelectAll();
        ...
        private void txt_packing_KeyPress(object sender, KeyPressEventArgs e)
        {
            FloatValueValidate(e);
        }

        private void txt_packing_MouseHover(object sender, EventArgs e)
        {
            txt_packing.SelectAll();
        }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            DataTable msg = new DataTable();
                 msg= obj.selectcustomernumber(txtMobile.Text);
                 if (msg.Rows.Count > 0)
                 {
                     MessageBox.Show("Customer already exist", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                     return;
                 ...
                 {
                     obj.InsertCustomerdetails(txtCustName.Text, txtEmail.Text, txtMobile.Text, "0", "0", "0", 0, 0, "0", 0);
