    ...
    public partial class Home1 : Form
    {
        ...
        private void btnProductStockReport_Click(object sender, EventArgs e)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                if (dt.Rows[0]["ViewStatus"].ToString() == "1")
                {
                    InvoiceReport obj = new InvoiceReport();
                    obj.TopLevel = false;
                    obj.AutoScroll = true;
                    splitContainer1.Panel2.Controls.Add(obj);
                    obj.Show();
        ...
        private void btnProductStockReport_Click_1(object sender, EventArgs e)
        {

        }

        private void btnProductStockReport_Click_2(object sender, EventArgs e)
        {
