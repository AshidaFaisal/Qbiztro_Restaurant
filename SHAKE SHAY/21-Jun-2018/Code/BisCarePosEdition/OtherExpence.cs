...
{
    public partial class OtherExpence : Form
    {
        public OtherExpence()
        {
            InitializeComponent();
        ...
        {
            DataSet ds = cb.GetExpence();
            cmb_expence.DataSource = ds.Tables[0];
            cmb_expence.DisplayMember = "Type";
            cmb_expence.ValueMember = "Id";
            DataRow dr = ds.Tables[0].NewRow();
            dr["Type"] = "--Select One--";
            dr["Id"] = "0";
            ds.Tables[0].Rows.InsertAt(dr, 0);
            cmb_expence.SelectedIndex = 0;
            f = 1;
        ...
        private void OtherExpence_Load(object sender, EventArgs e)
        {
            this.ActiveControl = txt_expence;
            loadcombo();
            txt_expence.Focus();
        ...
        private void Rb_edit_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                cmb_expence.Enabled = true;
                Btn_Delete.Enabled = true;
            }
            else
            {
                cmb_expence.Enabled = false;
                Btn_Delete.Enabled = false;
            }
        }
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            if (Rb_new.Checked == true)
            {
                if (txt_expence.Text == "")
                {
                    MessageBox.Show("Enter Expence ", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    txt_expence.Focus();
                }
                ...
                {
                   // String msg = cb.InsertorUpdateExpence("0", txt_expence.Text, dtp_date.Value, txt_discription.Text, txt_amount.Text, "0");
            ...
            {
                if (cmb_expence.SelectedIndex > 0)
                {
                    if (txt_expence.Text == "")
                    {
                        MessageBox.Show("Enter Expence ", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    ...
                    {
                        string msg = cb.InsertorUpdateIncome("1", txt_expence.Text, dtp_date.Value, txt_discription.Text, txt_amount.Text, cmb_expence.SelectedValue.ToString());
                        MessageBox.Show(msg, "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        loadcombo();
                        txt_expence.Text = "";
                        txt_amount.Text = "0";
                ...
                {
                    MessageBox.Show("Please select Expence", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cmb_expence.Focus();
                }
            }
        }
        ...
        private void Btn_Delete_Click(object sender, EventArgs e)
        {
            if (cmb_expence.SelectedIndex > 0)
            {
                string msg = cb.DeleteExpence(cmb_expence.SelectedValue.ToString());
                MessageBox.Show("Expence sucessfully deleted", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                MessageBox.Show("Please select an Expence", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                cmb_expence.Focus();
            }
        }
        ...
        private void cmb_expence_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (f == 1)
            {
               // cb.GetExpenceById(cmb_expence.SelectedValue.ToString());
                SqlDataReader dr = cb.GetExpenceById(cmb_expence.SelectedValue.ToString());
                if (dr.Read())
                {
                    txt_expence.Text = dr[2].ToString();
        ...
        private void txt_expence_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                txt_amount.Focus();
        ...
        private void cmb_expence_TextChanged(object sender, EventArgs e)
        {
            if (!cmb_expence.DroppedDown)
            {
                cmb_expence.Focus();
            }
        }
