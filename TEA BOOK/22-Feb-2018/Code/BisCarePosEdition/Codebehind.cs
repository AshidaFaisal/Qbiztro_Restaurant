...
namespace BisCarePosEdition
{
      ...
      string qty, string pr, string amnt, string icode, string adfont, string gfont, string datest, string cashier,string logo,string currency)
        ...
        ///////////////////////////////////////////remya////////////
         ...
         public DataSet GetItemCodeForStock()
          ...
          public void InsertKotDetail(string kotId, string ItemId, string Quantity, string Rate, string Amount, string TaxId, string TaxAmt, string Taxable, string TaxPer)
          {
            Opencon();
        ...
        public DataSet getdepartrment()
        {
          ...
          public void InsertInvoiceDetails(string inid, string itemid, string quantity, string rate, string amount, string kotid, string tableid, string waiterid, string token, string TaxId, string TaxAmt, string Taxable, string TaxPer)
          {
              Opencon();
    ...
    /////////////////////
        ...
        ////
          ...
          public DataTable GetItemTaxById(string id)
          {
              Opencon();
              cmd = new SqlCommand("spGetItemTax", con);
              cmd.CommandType = CommandType.StoredProcedure;
              cmd.Parameters.AddWithValue("@id", id);
              SqlDataAdapter da = new SqlDataAdapter(cmd);
              DataTable dt = new DataTable();
          ...
          {
              Opencon();
              cmd = new SqlCommand("spReportInvoiceSummary", con);
              cmd.CommandType = CommandType.StoredProcedure;
              cmd.Parameters.AddWithValue("@startdate", start);
              cmd.Parameters.AddWithValue("@enddate", end);
