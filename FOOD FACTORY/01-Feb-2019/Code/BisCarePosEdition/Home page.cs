        ...
        {    
            ...
            if (dt.Rows.Count > 0)
            {
                if (dt.Rows[0]["ViewStatus"].ToString() == "1")
                {
                    ...
                    else if (dtbuttons.Rows[0]["Formname"].ToString() == "Invoice Report")
                    {
                        InvoiceReport dp = new InvoiceReport();
                        dp.ShowDialog();
                        dp.TopLevel = false;
                        dp.AutoScroll = true;
                        splitContainer2.Panel2.Controls.Add(dp);
                    ...
                    else if (dtbuttons.Rows[0]["Formname"].ToString() == "Item Report")
                    {
                        Items_Report sr = new Items_Report();
                        sr.ShowDialog();
                        sr.TopLevel = false;
                        sr.AutoScroll = true;
                        splitContainer2.Panel2.Controls.Add(sr);
