...
{
    public partial class StockEntrySearch : Form
    {
        public StockEntrySearch()
        {
            InitializeComponent();
        }
            ...
            if (f == 1)
            {
                if (chk_oldStock.Checked == false)
                {
                    if ((ch_itemname.Checked == true) && (ch_date.Checked == false))
                    {
                        ...
                        {
                            dt = obj.SearchStiock("2", start, end, cmb_itemname.SelectedValue.ToString());
                        }
                        else
                        {
                    ...
                    else
                    {
                        if ((ch_itemname.Checked == false) && (ch_date.Checked == true))
                        {
                            ...
                            dt = obj.SearchStiock("1", start, end, cmb_itemname.SelectedValue.ToString());
                        ...
                        else
                        {
                            if ((ch_itemname.Checked == true) && (ch_date.Checked == true))
                            {
                                ...
                                if (cmb_itemname.SelectedIndex > 0)
                                {
                                    dt = obj.SearchStiock("3", start, end, cmb_itemname.SelectedValue.ToString());
                                }
                                else
                                {
                                    MessageBox.Show("Please select an item", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                else
                {
                    ...
                    {
                        dt = obj.SearchStockOld("2",start,end);
                    }
                    else
                    {
                        dt = obj.SearchStockOld("1",start,end);
                    }
                ...
                for (i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    gv_stocksearch[8, i].Value = dt.Rows[i]["MasterId"].ToString();
        ...
        private void gv_stocksearch_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                int r = e.RowIndex;
                id = gv_stocksearch[8, r].Value.ToString();
                dr = DialogResult.OK;
                this.Close();
