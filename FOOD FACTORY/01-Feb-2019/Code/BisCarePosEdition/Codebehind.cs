...
namespace BisCarePosEdition
{
    class Codebehind
    {
        ...
        public DataTable ReportIvoice(DateTime start, DateTime end)
        {
            Opencon();
            cmd = new SqlCommand("SP_Invoice_Reports", con);
            cmd.CommandType = CommandType.StoredProcedure;
      ...
      string qty, string pr, string amnt, string icode, string adfont, string gfont, string datest, string cashier,string logo,string currency)
        ...
        ///////////////////////////////////////////remya////////////
         ...
         public DataSet GetItemCodeForStock()
          ...
          public string InsertKotMaster(string custname, string custmob, string custemail, string totalamount, string billingst, string table, string waiter,string custstat,string token,DateTime date1,string department,string TokenStatus,string pk,string reference )
          {
              Opencon();
              ...
              cmd.Parameters.AddWithValue("@pakchrg", pk);
        ...
        public DataSet getdepartrment()
        {
          ...
          public string InsertInvoiceMaster(string inNo, DateTime date, string custname, string custmob, string custemail,
              ...
              string packingcharge, int billtype, DateTime storedate, int paymode, string cashamt, string cardamt,string billingmode)
          {
              Opencon();
        ...
        public DataTable GetPendingKOTTakeAway()
          ...
          public void DeleteKotDetaile(string id,string tableid, string kot,string mode)
          {
              Opencon();
              ...
              cmd.Parameters.AddWithValue("@kot", id);
              cmd.Parameters.AddWithValue("@tableid", tableid);
              cmd.Parameters.AddWithValue("@token", kot);
              cmd.Parameters.AddWithValue("@mode", mode);
              cmd.ExecuteNonQuery();
          }
          public void DeleteKotMaster(string id, string tableid,string kot, string mode)
          {
              Opencon();
    ...
    /////////////////////
        ...
        //////////////////
          ...
          public DataTable selectcustomernumber(string phone)
          {
              Opencon();
              cmd = new SqlCommand("SP_CustomerNO", con);
              cmd.CommandType = CommandType.StoredProcedure;
          ...
          public string InsertCustomerdetails(string customername, string adress, string phone, string email, string tinno, string cstno, int openingbalance, int Credit, string code, int CreditAmount)
          {
              Opencon();
              cmd = new SqlCommand("SP_SAVE_CUSTOMERDetails", con);
              cmd.CommandType = CommandType.StoredProcedure;
              cmd.Parameters.AddWithValue("@customername", customername);
              cmd.Parameters.AddWithValue("@adress", adress);
              cmd.Parameters.AddWithValue("@phone", phone);
          ...
          public DataTable EditCustomers(string phone)
          {
              Opencon();
              cmd = new SqlCommand("SP_EditCustomerno", con);
              cmd.CommandType = CommandType.StoredProcedure;
              //cmd.Parameters.AddWithValue("@customer_id", cust_id);
              cmd.Parameters.AddWithValue("@phno", phone);
              DataTable dt = new DataTable();
