...
{
    public partial class ReportOtherExpence : Form
    {
        public ReportOtherExpence()
        {
            InitializeComponent();
        }
        ...
        private void ReportOtherExpence_Load(object sender, EventArgs e)
        {
            try
            {
                ApplyTheme();
        ...
        private void Cbox_type_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (mode > 0)
            {
                try
                {
                    dtCounterBill = cb.ReportOtherExpense(dtp_start.Value, dtp_end.Value, cmb_newtype.Text, mode);
                    PrintCounterBill();
                }
                catch (Exception ex)
                {
        ...
        private void Doc_PrintPageCounterBill(object sender, PrintPageEventArgs e)
        {
            ...
            if (dtCounterBill.Rows.Count > 0)
            {
                ...
                //y += lineHeight;
                e.Graphics.DrawString("   OTHER EXPENSE REPORT", font10, new SolidBrush(Color.Black), 0, y);
