...
namespace BisCarePosEdition
{
    public partial class Billing : Form
    {
        ...
        
       {
                    ...
                    for (i = 0; i < li.Count; i++)
                    {
                      string  mg = obj.InsertKotMaster(txtCustName.Text, txtMobile.Text, txtEmail.Text, txt_total.Text, "0", cbox_table.SelectedValue.ToString(), cbox_waiter.SelectedValue.ToString(), custst, "0", dtpDate.Value, li[i],tokenst);
                        ...
                        for (int k = 0; k < dgv_ItemDteails.Rows.Count; k++)
                        {
                            ...
                            {
                                obj.InsertKotDetail(mg, dgv_ItemDteails[9, k].Value.ToString(), dgv_ItemDteails[3, k].Value.ToString(), dgv_ItemDteails[4, k].Value.ToString(), dgv_ItemDteails[5, k].Value.ToString(), dgv_ItemDteails["TaxId", k].Value.ToString(), dgv_ItemDteails["TaxAmt", k].Value.ToString(), dgv_ItemDteails["Taxable", k].Value.ToString(), dgv_ItemDteails["TaxPer", k].Value.ToString());
                 ...
                 if (c != 1)
                 {
                     ...
                     if (f == 1)
                     {
                         ...
                         for (int d = 0; d < dt.Rows.Count; d++)
                         {
                             ...
                             dgv_KotDetails["TaxPerKot", d].Value = dt.Rows[d]["TaxPer"].ToString();
                             dgv_KotDetails["TaxIdKot", d].Value = dt.Rows[d]["TaxId"].ToString();
                             dgv_KotDetails["TaxAmtKot", d].Value = dt.Rows[d]["TaxAmt"].ToString();
                             dgv_KotDetails["TaxableKot", d].Value = dt.Rows[d]["Taxable"].ToString();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            int TaxId = 0;
            DataTable DtGetTax = new DataTable();
                ...
                if (st == "1")
                {
                    ...
                    if (rd_counterBill.Checked == true)
                    {
                        if (addst == "0")
                        {
                            ...
                            DtGetTax = obj.GetItemTaxById(cbox_ItemName.SelectedValue.ToString());
                            TaxPercent = Convert.ToDouble(DtGetTax.Rows[0]["Percentage"].ToString());
                            TaxId = Convert.ToInt32(DtGetTax.Rows[0]["TaxId"].ToString());
                            ...
                            double NetValueAmt = NetValue(Convert.ToDouble(txt_Rate.Text), TaxPercent);
                            dgv_ItemDteails["Taxable", i].Value = NetValueAmt.ToString("F2");
                            dgv_ItemDteails["TaxPer", i].Value = TaxPercent;
                            double taxAmt = ((Convert.ToDouble(txt_Rate.Text) - Convert.ToDouble(NetValueAmt)) * Convert.ToDouble(txt_Quantity.Text));
                            dgv_ItemDteails["TaxAmt", i].Value = taxAmt.ToString("F2");
                            dgv_ItemDteails["TaxId", i].Value = TaxId;
             ...
             if (dgv_ItemDteails.Rows.Count > 0)
                {
                    if (custst == "2")
                    {
                        ...
                        {
                            obj.InsertKotDetail(msg, dgv_ItemDteails[9, i].Value.ToString(), this.dgv_ItemDteails[3, i].Value.ToString(), dgv_ItemDteails[4, i].Value.ToString(), dgv_ItemDteails[5, i].Value.ToString(), dgv_ItemDteails["TaxId", i].Value.ToString(), dgv_ItemDteails["TaxAmt", i].Value.ToString(), dgv_ItemDteails["Taxable", i].Value.ToString(), dgv_ItemDteails["TaxPer", i].Value.ToString());
                           }
                    }
                    if (custst == "4")
                    {
                        ...
                        for (int i = 0; i < dgv_ItemDteails.Rows.Count; i++)
                        {
                            obj.InsertKotDetail(msg, dgv_ItemDteails[9, i].Value.ToString(), dgv_ItemDteails[3, i].Value.ToString(), dgv_ItemDteails[4, i].Value.ToString(), dgv_ItemDteails[5, i].Value.ToString(), dgv_ItemDteails["TaxId", i].Value.ToString(), dgv_ItemDteails["TaxAmt", i].Value.ToString(), dgv_ItemDteails["Taxable", i].Value.ToString(),dgv_ItemDteails["TaxPer", i].Value.ToString());
                        }
                        ...
                        for ( i = 0; i < li.Count; i++)
                            {
                                ...
                                {     
                                   if (li[i] == this.dgv_ItemDteails[13, k].Value.ToString())
                                    {
                                        obj.InsertKotDetail(msg, dgv_ItemDteails[9, k].Value.ToString(), dgv_ItemDteails[3, k].Value.ToString(), dgv_ItemDteails[4, k].Value.ToString(), dgv_ItemDteails[5, k].Value.ToString(), dgv_ItemDteails["TaxId", k].Value.ToString(), dgv_ItemDteails["TaxAmt", k].Value.ToString(), dgv_ItemDteails["Taxable", k].Value.ToString(), dgv_ItemDteails["TaxPer", k].Value.ToString());
    ...
    try
    {
        if (dtKOT.Rows.Count > 0)
        {
            ...
            e.Graphics.DrawString("KOT: " + dtKOT.Rows[0]["kotno"].ToString(), font10, sBrush, 0, y);
            lineHeight = font12.GetHeight(e.Graphics);
            y += lineHeight;
                    ...
                    if (txtInvoiceNumber.Text != "")
                    {
                        ...
                        if (rd_counterBill.Checked == true)
                        {
                            ...
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                for (int i = 0; i < dgv_ItemDteails.Rows.Count; i++)
                                {
                                  TotalTaxAmt=Convert.ToDouble( dgv_ItemDteails["TaxAmt", i].Value.ToString());
                                }
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), CustName, txtMobile.Text,
                                    ...
                                    Convert.ToString(CustId), user, txt_packing.Text, billtype, DateTime.Now,
                                  0, txt_total1.Text, "0.00", "Billing", TotalTaxAmt.ToString());
                                ...
                                else
                                {
                                    for (int i = 0; i < dgv_ItemDteails.Rows.Count; i++)
                                    {
                                        obj.InsertInvoiceDetails(msg, dgv_ItemDteails[9, i].Value.ToString(), dgv_ItemDteails[3, i].Value.ToString(), dgv_ItemDteails[4, i].Value.ToString(), dgv_ItemDteails[5, i].Value.ToString(), "0", "0", "0", "0", dgv_ItemDteails["TaxId", i].Value.ToString(), dgv_ItemDteails["TaxAmt", i].Value.ToString(), dgv_ItemDteails["Taxable", i].Value.ToString(), dgv_ItemDteails["TaxPer", i].Value.ToString());
                                    }
                        ...
                        else
                        {
                            ...
                            if (dgv_KotDetails.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    for (int i = 0; i < dgv_KotDetails.Rows.Count; i++)
                                    {
                                        TotalTaxAmt = Convert.ToDouble(dgv_KotDetails["TaxAmtKot", i].Value.ToString());
                                    }
                                    ...
                                    msg1 = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), CustName, txtMobile.Text, txtEmail.Text, status, txt_total.Text,
                                        combliment, txt_discount.Text, paidamnt, customerst, Convert.ToString(CustId), user, txt_packing.Text, billtype, DateTime.Now,
                                       0, txt_total1.Text, "0.00", "Billing", TotalTaxAmt.ToString());
                                    ...
                                    else
                                    {
                                        for (int i = 0; i < dgv_KotDetails.Rows.Count; i++)
                                        {
                                            obj.InsertInvoiceDetails(msg1, dgv_KotDetails[8, i].Value.ToString(), dgv_KotDetails[3, i].Value.ToString(), dgv_KotDetails[4, i].Value.ToString(), dgv_KotDetails[5, i].Value.ToString(), dgv_KotDetails[9, i].Value.ToString(), dgv_KotDetails[10, i].Value.ToString(), dgv_KotDetails[11, i].Value.ToString(), dgv_KotDetails[12, i].Value.ToString(), dgv_KotDetails["TaxIdKot", i].Value.ToString(), dgv_KotDetails["TaxAmtKot", i].Value.ToString(), dgv_KotDetails["TaxableKot", i].Value.ToString(), dgv_KotDetails["TaxPerKot", i].Value.ToString());
                                        }
                ...
                if (dtCounterBill.Rows.Count > 0)
                {
                  ...
                  //float xamount = 200;
                    ...
                    if (result1 != null)
                    {
                       ...
                       // e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address1"].ToString(), 36), font, new SolidBrush(Color.Black), -25, y);
                       // lineHeight = font15.GetHeight(e.Graphics);
                       // y += lineHeight;
                    }
                    ...
                    if (result2 != null)
                    {
                       ...
                       // e.Graphics.DrawString( CenterString(dtprintfeatures.Rows[0]["address2"].ToString(),55), font10, new SolidBrush(Color.Black), 0, y);
                        e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address2"].ToString(), 55), font10, new SolidBrush(Color.Black), -60, y);
                    ...
                    if (result3 != null)
                    {
                        ...
                        e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address3"].ToString(), 48), font10, new SolidBrush(Color.Black), -60, y);
                        lineHeight = font10.GetHeight(e.Graphics);
                        y += lineHeight;
                    }
                     ...
                     if (result4 != null)
                     {
                        // e.Graphics.DrawString(             CenterString(dtprintfeatures.Rows[0]["address4"].ToString(),45), font10, new SolidBrush(Color.Black), 0, y);
                         e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address4"].ToString(), 45), font10, new SolidBrush(Color.Black), -60, y);
                         lineHeight = font10.GetHeight(e.Graphics);
                         y += lineHeight;
                     }
                     ...
                     if ((result5 != null)&&(result5!=""))
                     {
                        // e.Graphics.DrawString(       CenterString(dtprintfeatures.Rows[0]["address5"].ToString(),55), font10, new SolidBrush(Color.Black), 0, y);
                         e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address5"].ToString(), 55), font10, new SolidBrush(Color.Black), -60, y);
                         lineHeight = font10.GetHeight(e.Graphics);
                         y += lineHeight;
                     }
                     y += lineHeight;
                   // e.Graphics.DrawString(     CenterString(dtprintfeatures.Rows[0]["BillName"].ToString(),46), font12, new SolidBrush(Color.Black), 0, y);
                    e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["BillName"].ToString(), 46), font12, new SolidBrush(Color.Black), -25, y);
                    lineHeight = font12.GetHeight(e.Graphics);
                    y += lineHeight;
                    ...
                    {
                        e.Graphics.DrawString("Bill No: " + dtCounterBill.Rows[0]["InvoiceNo"].ToString() + ",    Date: " + Convert.ToDateTime(DateTime.Now).ToShortDateString(), font9, sBrush, 0, y);
                    lineHeight = font9.GetHeight(e.Graphics);
                    y += lineHeight;
                    }
                    if (counterId != 0)
                    ...
                    else
                    {
                        ...
                        if (Convert.ToDouble(dtCounterBill.Rows[0]["PckCharge"]) > 0)
                        {
                           ...
                           // e.Graphics.DrawString("Total            : Rs." + total.ToString("F2"), font12, sBrush, 40, y);
                            e.Graphics.DrawString("Total             :      Rs." + total.ToString("F2"), font10, sBrush, 0, y);
                            lineHeight = font12.GetHeight(e.Graphics);
                            y += lineHeight;
                            if (Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString()) >0)
                        {
                           // e.Graphics.DrawString("Discount      : Rs." + dtCounterBill.Rows[0]["discount"].ToString(), font12, sBrush, 40, y);
                            e.Graphics.DrawString("Discount       :      Rs." + dtCounterBill.Rows[0]["discount"].ToString(), font10, sBrush, 0, y);
                            lineHeight = font10.GetHeight(e.Graphics);
                            y += lineHeight;
                        }
                            ...
                            e.Graphics.DrawString("NetValue      :      Rs." + (total - Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString())).ToString("F2"), font10, sBrush, 0, y);
                            lineHeight = font12.GetHeight(e.Graphics);
                            y += lineHeight;
                        }
                   ...
                   // e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["greeting1"].ToString(),60), Fonts1, sBrush, 0, y);
                    e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["greeting1"].ToString(), 60), Fonts1, sBrush, -50, y);
                    lineHeight = font9.GetHeight(e.Graphics);
                    y += lineHeight;
            ...
            try
            {
                ...
                if (dtBill.Rows.Count > 0)
                {
                    ...
                    if (dtprintfeatures.Rows[0]["address1"].ToString() != null)
                    {
                        ...
                        //y += lineHeight;
                        //e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address1"].ToString(), 25), Ft, new SolidBrush(Color.Black), -25, y);
                        //lineHeight = font15.GetHeight(e.Graphics);
                        //y += lineHeight;
                    }
                    if(dtprintfeatures.Rows[0]["address2"].ToString()!=null)
                    {
                        e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address2"].ToString(),52), font10, new SolidBrush(Color.Black), -60, y);
                    lineHeight = font10.GetHeight(e.Graphics);
                    y += lineHeight;
                      }
                    ...
                    {
                        e.Graphics.DrawString(CenterString(dtprintfeatures.Rows[0]["address4"].ToString(),55), font10, new SolidBrush(Color.Black), -60, y);
                    lineHeight = font10.GetHeight(e.Graphics);
                    y += lineHeight;
                     }
                   ...
                   if(dtprintfeatures.Rows[0]["BillName"].ToString()!=null)
                   {
                    ...
                    if (dtprintfeatures.Rows[0]["BillNo"].ToString() == "1")
                    {
                        e.Graphics.DrawString("Bill No: " + dtBill.Rows[0]["InvoiceNo"].ToString() + ",   Date : " + Convert.ToDateTime (DateTime.Now).ToShortDateString(), font9, sBrush, 0, y);
                    lineHeight = font10.GetHeight(e.Graphics);
                    y += lineHeight;
                    y += lineHeight;
                    }
                   ...
                   //   e.Graphics.DrawString("Sl ", font9, sBrush, xSlno, y);
                    ...
                    {        
                        ...
                        y += lineHeight;
                            ...
                            {
                                e.Graphics.DrawString("Discount       :      Rs." + dtBill.Rows[0]["discount"].ToString(), font10, sBrush, 0, y);
                                lineHeight = font10.GetHeight(e.Graphics);
                                y += lineHeight;
                            }
                            e.Graphics.DrawString("NetValue      :      Rs." + (total - Convert.ToDouble(dtBill.Rows[0]["discount"].ToString())).ToString("F2"), font10, sBrush, 0, y);
                            lineHeight = font12.GetHeight(e.Graphics);     
                        }
                        ...
                        if (rd_counterBill.Checked == true)
                        {
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), txtCustName.Text, txtMobile.Text, txtEmail.Text, 3, txt_total.Text, combliment,
                                    txt_discount.Text, paidamnt, customerst, customerid, "0.00", user, billtype,DateTime.Now
                                    , 0, txt_total1.Text, "0.00", "Billing", TotalTaxAmt.ToString());//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                if (combliment == 1)
                                {
                                    obj.InsertComplimentary(msg, remarks);
                                }
                            ...
                            if (dgv_KotDetails.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    msg1 = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(globalvariable.StoreDate), txtCustName.Text, txtMobile.Text, txtEmail.Text, status, txt_total.Text, combliment, txt_discount.Text, paidamnt, customerst,
                                        customerid, "0.00", user, billtype, DateTime.Now, 0, txt_total1.Text, "0.00", "Billing", TotalTaxAmt.ToString());
                                    if (combliment == 1)//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                    {
                                        obj.InsertComplimentary(msg1, remarks);
                                    }
...
try
{
    ...
    if (e.RowIndex >= 0 && e.ColumnIndex == 16)
    {
            ...
            obj.InsertKotDetail(m, dgv_KotDetails[11, e.RowIndex].Value.ToString(), this.dgv_KotDetails[3, e.RowIndex].Value.ToString(), this.dgv_KotDetails[4, e.RowIndex].Value.ToString(), dgv_KotDetails[5, e.RowIndex].Value.ToString(), dgv_ItemDteails["TaxId", e.RowIndex].Value.ToString(), dgv_ItemDteails["TaxAmt", e.RowIndex].Value.ToString(), dgv_ItemDteails["Taxable", e.RowIndex].Value.ToString(), dgv_ItemDteails["TaxPer", e.RowIndex].Value.ToString());
...
File.AppendAllText("log.txt", DateTime.Now.ToString() + " - " + this.Name + Environment.NewLine + ex.ToString() + Environment.NewLine);
                    ...
                    try
                    {
                        ...
                        if (isNum)
                        {
                            ...
                            else
                            {
                                ...
                                double Netamt = Convert.ToDouble(txt_total.Text);
        ...
        public double NetValue(double Total, double TaxPercent)
        {
            double str = (100 * Total) / (100 + TaxPercent);
            return str;
        }
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    ...
                    if (isNum)
                    {
                        ...
                        //}
                        if ((txt_discount.Text == "") || (txt_total1.Text == ""))
                        {
                            return;
                        }
                        else
                        {
                            double dis = Convert.ToDouble(txt_discount.Text);
                            double Netamt = Convert.ToDouble(txt_total1.Text);
                            txtDiscountPercent.Text = ((dis * 100) / Netamt).ToString("F2");
                        }
        ...
        private void SetCounterBillDefault()
        {
            rd_dinein.Checked = true;
            rd_counterBill.Checked = false;
            rd_dinein.Checked = false;
