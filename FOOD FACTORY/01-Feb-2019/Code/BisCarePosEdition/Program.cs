...
namespace BisCarePosEdition
{
    ...
    static class Program
    {
      ...
      // Application.Run(new DeletePasswordChange());
            DateTime yourDate =Convert.ToDateTime( "24-08-2017");
       ...
       p1: Login ObjLogin = new Login();
           ...
           if (r == DialogResult.OK)
           {
               ...
               //else
               //{
               //    MessageBox.Show("Please Contact Loyal IT Solutions...", "Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
               //}
           }
