...
namespace BisCarePosEdition
{
    public partial class Billing : Form
    {
        ...
        Font font14 = new Font("Arial", 14, GraphicsUnit.Point);
        ...
        Font Addr1Font = new Font("Arial", 12, FontStyle.Bold);
        ...
        
       {
                 ...
                 if (c != 1)
                 {
                     ...
                     if (f == 1)
                     {
                         ...
                         for (int d = 0; d < dt.Rows.Count; d++)
                         {
                             ...
                             if (dt.Rows[d]["CustomerName"].ToString() == "CASH")
                             {
                                 radiocash.Checked = true;
                             ...
                             else
                             {
                                 ...
                                 cmbcustomer.Text = dt.Rows[d]["CustomerName"].ToString();
                             }
                         }
                         double total = 0;
                       ...
                       //  txt_total.Text = Convert.ToString(Convert.ToString(decimal.Round(Convert.ToDecimal(((Convert.ToDouble(txt_total1.Text) * 5) / 100) + Convert.ToDouble(txt_total1.Text)), 2, MidpointRounding.AwayFromZero)));
                         ...
                         txt_total.Text = txt_total1.Text;
            ...
            try
            {
                if (f == 1)
                {
                    ...
                    if (dr.Read())
                    {
                        ...
                        string priceChangeStatus = dr["ChangeSellpricestatus"].ToString();
                        if (priceChangeStatus == "1")
                        {
        ...
        private void txt_Rate_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (txt_Rate.Text == "")
                {
                    txt_Rate.Text = "0"; txt_OrgRate.Text = "0";
                }
                ...
                if (isNum)
                {
                    if (txt_Quantity.Text != "" && txt_Rate.Text != "")
                    {
                        txt_Rate.Text = Convert.ToString(decimal.Round(Convert.ToDecimal(txt_Rate.Text), 4, MidpointRounding.AwayFromZero));
                        ...
                        {
                           // decimal orgPrice = (decimal.Parse(txt_Rate.Text) * 105) / 100;
                            txt_OrgRate.Text = txt_Rate.Text;
                        }
                    }
                }
                else
                        ...
                        for ( i = 0; i < li.Count; i++)
                            {
                                ...
                                msg = obj.InsertKotMaster(CustName, txtMobile.Text, txtEmail.Text, txt_total.Text, "0", cbox_table.SelectedValue.ToString(), cbox_waiter.SelectedValue.ToString(), custst, "0", dtpDate.Value, li[i], tokenst);
        ...
        
    {
                    ...
                    if (txtInvoiceNumber.Text != "")
                    {
                        ...
                        if (rd_counterBill.Checked == true)
                        {
                            ...
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(DateTime.Now.ToString()), CustName, txtMobile.Text,
                                    txtEmail.Text, 3, txt_total1.Text, combliment, txt_discount.Text, paidamnt, customerst,
                                    Convert.ToString(CustId), user, txt_packing.Text, billtype, Convert.ToDateTime(globalvariable.StoreDate),
                                    1  ,txt_total1.Text,"0.00", "Billing",txttax.Text==""?"0.00":txttax.Text);
                        ...
                        else
                        {
                            ...
                            if (dgv_KotDetails.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (radiocredit.Checked == true)
                                        paidamnt = "0";
                                    msg1 = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(DateTime.Now.ToString()), CustName, txtMobile.Text, txtEmail.Text, status, txt_total.Text,
            ...
            try
            {
                ...
                if (dtCounterBill.Rows.Count > 0)
                {
                  ...
                  //float xamount = 200;
                    ...
                    {
                        e.Graphics.DrawString("Bill No: " + dtCounterBill.Rows[0]["InvoiceNo"].ToString() + ",    Date: " + dtCounterBill.Rows[0]["date"].ToString(), font9, sBrush, 0, y);
                    lineHeight = font9.GetHeight(e.Graphics);
                    y += lineHeight;
                    }
                    if (radiocredit.Checked == true)
                    {
                            e.Graphics.DrawString("Customer Name: " + dtCounterBill.Rows[0]["CustomerName"].ToString(), font9, sBrush, 0, y);
                            lineHeight = font9.GetHeight(e.Graphics);
                            y += lineHeight;
                    ...
                    else
                    {
                            ...
                            if (Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString()) >0)
                        {
                            ...
                            AmtWithoutRoundOff = total  - Convert.ToDouble(dtCounterBill.Rows[0]["discount"].ToString()) + pckcharge;
                    ...
                    e.Graphics.DrawString("      www.loyalitsolutions.com", font9, sBrush, 55, y);
                }
            }
            catch (Exception ex)
            ...
            try
            {
                ...
                if (dtBill.Rows.Count > 0)
                {
                   ...
                   if(dtprintfeatures.Rows[0]["BillName"].ToString()!=null)
                   {
                    ...
                    if (dtprintfeatures.Rows[0]["BillNo"].ToString() == "1")
                    {
                        e.Graphics.DrawString("Bill No: " + dtBill.Rows[0]["InvoiceNo"].ToString() + ",   Date : " + dtBill.Rows[0]["date"].ToString(), font9, sBrush, 0, y);
                    lineHeight = font10.GetHeight(e.Graphics);
                    y += lineHeight;
                    }
                    if (radiocredit.Checked == true)
                    {
                        e.Graphics.DrawString("Customer Name: " + dtBill.Rows[0]["CustomerName"].ToString(), font9, sBrush, 0, y);
                        lineHeight = font9.GetHeight(e.Graphics);
                        y += lineHeight;
                    ...
                    {        
                        y += 7;
                           ...
                           // double totaltx = ((((total) * 5)) / 100) / 2;
                            ...
                            double AmtWithRoundOff = 0;
                            double AmtWithoutRoundOff = 0;
                            AmtWithoutRoundOff = total  - Convert.ToDouble(dtBill.Rows[0]["discount"].ToString()) + pckcharge;
                            AmtWithRoundOff = CalcAmtRoundOff(Convert.ToDouble(AmtWithoutRoundOff));
        ...
        private void counterBill_CheckedChangedFun()
        {
            try
            {
                if (c != 1)
                    ...
                    if (txtInvoiceNumber.Text != "")
                    {
                        if (rd_counterBill.Checked == true)
                        {
                            if (dgv_ItemDteails.Rows.Count > 0)
                            {
                                ...
                                string msg = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(DateTime.Now.ToString()), txtCustName.Text, txtMobile.Text, txtEmail.Text, 3, txt_total.Text, combliment,
                                    txt_discount.Text, paidamnt, customerst, customerid, "0.00", user, billtype, Convert.ToDateTime(globalvariable.StoreDate)
                                    , 1, txt_total1.Text, "0.00", "Billing", txttax.Text == "" ? "0.00" : txttax.Text);//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                if (combliment == 1)
                                {
                                    obj.InsertComplimentary(msg, remarks);
                                }
                        ...
                        else
                        {
                            ...
                            if (dgv_KotDetails.Rows.Count > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    msg1 = obj.InsertInvoiceMaster(txtInvoiceNumber.Text, Convert.ToDateTime(DateTime.Now.ToString()), txtCustName.Text, txtMobile.Text, txtEmail.Text, status, txt_total.Text, combliment, txt_discount.Text, paidamnt, customerst,
                                        customerid, "0.00", user, billtype, Convert.ToDateTime(globalvariable.StoreDate), 1, txt_total1.Text, "0.00", "Billing", txttax.Text == "" ? "0.00" : txttax.Text);
                                    if (combliment == 1)//Convert.ToDateTime(globalvariable.StoreDate)//dtpDate.Value
                                    {
                                        obj.InsertComplimentary(msg1, remarks);
                                    }
...
File.AppendAllText("log.txt", DateTime.Now.ToString() + " - " + this.Name + Environment.NewLine + ex.ToString() + Environment.NewLine);
        ...
        private double RetTotalVal()
        {
            double RetVal = 0;
            try
            {
               // string tot  = Convert.ToString(Convert.ToString(decimal.Round(Convert.ToDecimal(((Convert.ToDouble(txt_total1.Text) * 5) / 100) + Convert.ToDouble(txt_total1.Text)), 2, MidpointRounding.AwayFromZero)));

                string tot = Convert.ToString(Convert.ToString(decimal.Round(Convert.ToDecimal(  Convert.ToDouble(txt_total1.Text)), 2, MidpointRounding.AwayFromZero)));


                double AmtWithRoundOff = 0;
                AmtWithRoundOff = CalcAmtRoundOff(Convert.ToDouble(tot));
                RetVal = AmtWithRoundOff;
                if (txt_discount.Text != "")
                {
                    RetVal = RetVal - double.Parse(txt_discount.Text);
                }
            }
            catch (Exception ex)
            {
        ...
        private void txt_packing_TextChanged(object sender, EventArgs e)
        {
            try
            {
                double totVaalue = RetTotalVal();
                double RetVal = totVaalue;
               // RetVal = CalcTotalPacking(Convert.ToDouble(txt_total.Text), Convert.ToDouble(txt_packing.Text));
                if (txt_packing.Text != "")
                {
                    RetVal = CalcTotalPacking(totVaalue, Convert.ToDouble(txt_packing.Text));
                }
                txt_total.Text = RetVal.ToString("F2");
        ...
        private double CalcTotalPacking(double TotWithoutpack, double pkAmt)
        {
            ...
            try
            {
                ...
                TotWithDiscTax = TotWithoutpack + pkAmt;

                //if (txt_discount.Text != "")
               // {
                 //   TotWithDiscTax = TotWithDiscTax - Convert.ToDouble(txt_discount.Text);
                //}
            }
            catch (Exception ex)
            {
        ...
        private double CalcTotalDiscount(double TotWithoutDisc,double DiscAmt,double DiscTax)
        {
            ...
            try
            {
                ...
                if (txt_packing.Text != "")
                {
                    TotWithDiscTax = TotWithDiscTax + double.Parse(txt_packing.Text);
                }
            }
            catch (Exception ex)
            {
